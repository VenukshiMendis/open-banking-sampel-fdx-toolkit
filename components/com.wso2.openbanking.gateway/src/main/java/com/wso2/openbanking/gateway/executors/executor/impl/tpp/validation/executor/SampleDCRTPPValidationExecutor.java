...
import com.wso2.openbanking.accelerator.gateway.executor.impl.tpp.validation.executor.DCRTPPValidationExecutor;
 ...
 */
public class SampleDCRTPPValidationExecutor extends DCRTPPValidationExecutor {
    ...
    public List<PSD2RoleEnum> getRolesFromSSA(String softwareStatement) throws TPPValidationException {
        return super.getRolesFromSSA(softwareStatement);
    }
}
